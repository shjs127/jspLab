					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="dist/img/me.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												...
												<h4>
													Admin바꿈 Design Team <small><i class="fa fa-clock-o"></i>
														2 hours</small>
												</h4>
												<p>Why not buy a new awesome theme?</p>
										</a></li>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="dist/img/me.jpg" class="user-image" alt="User Image">
								<span class="hidden-xs"><%=request.getParameter("email") %></span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img src="dist/img/me.jpg"
									class="img-circle" alt="User Image">

									<p>
										박보검 닮았다는 소리 자주들어요 <small>비밀!!!</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li class="active"><a href="index.html"><i
									class="fa fa-circle-o"></i> 달리기 창</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="pages/examples/josun.html"><i
									class="fa fa-circle-o"></i> 조선 닷컴</a></li>
							<li><a href="pages/examples/normal.html"><i
					...
					<section class="col-lg-7 connectedSortable">
						...
						<div class="box box-success">
							...
							<div class="box-body chat" id="chat-box">
								<!-- chat item -->
								<div class="item">
									<img src="dist/img/me.jpg" alt="user image" class="online">

									<p class="message">
										<a href="#" class="name"> <small
											class="text-muted pull-right"><i
												class="fa fa-clock-o"></i> 2:15</small> 신준섭
										</a> 사람들이 자꾸만 나보고 박보검 닮았다던데 정말 피곤하고 짜증난다.
									</p>
									<div class="attachment">
										<h4>이수하</h4>
										<p class="filename">노래 가사에요?</p>
										</p>
										<div class="attachment">
											<h4>이정현</h4>
											<p class="filename">카페에 공유하면 안돼요?</p>
											</p>
											<div class="attachment">
												<h4>양준서</h4>

												<p class="filename">같은 조 여서 저희도 피해입는거 아니에요?</p>
												<div class="pull-right">
													<button type="button"
										...
										<!-- chat item -->
										<div class="item">
											<img src="dist/img/me.jpg" alt="user image" class="offline">
