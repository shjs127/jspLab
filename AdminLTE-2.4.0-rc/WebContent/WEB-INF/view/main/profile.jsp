					...
					<div class="tab-content">
						<div class="tab-pane" id="activity">
							...
							<div class="post">
								<div class="user-block">
									<img class="img-circle img-bordered-sm"
										src="${pageContext.request.contextPath}/resources/dist/img/user6-128x128.jpg"
										alt="User Image"> <span class="username"> <a
										...
										<div class="row">
											<div class="col-sm-6">
												<img class="img-responsive"
													...
													src="${pageContext.request.contextPath}/resources/dist/img/photo3.jpg"
													alt="Photo">
											</div>
											<!-- /.col -->
											<div class="col-sm-6">
												<img class="img-responsive"
													src="${pageContext.request.contextPath}/resources/dist/img/photo4.jpg"
													alt="Photo"> <br> <img class="img-responsive"
													src="${pageContext.request.contextPath}/resources/dist/img/photo1.png"
													alt="Photo">
											</div>
