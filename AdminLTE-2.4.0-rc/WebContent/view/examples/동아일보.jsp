...
<%@ include file="../include/header.jspf" %>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					동아일보 <small>it all starts here</small>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="box-body">
						...
						<script type="text/javascript" class="init">
							$(document).ready(function() {
								...
								var keys = "&api_key=bdx39dhahcvteeihirm0uldklxf5xragplj5dzwt";
								...
								$.ajax({
									...
									success : function(data) { //성공적으로 요청했왔을 때...
										...
										$.each(data.items, function(i, d) {
											...
											$("tbody").append('<tr><td>'+m+'</td><td><img src="'+img+'"width="50" height="50"></td><td>'+categories+'</td><td><a href="'+lk+'" target="_blank">'
															+ title + '</a></td><td>'+author+'</td></tr>');
										}); // “$.each” 메서드에 종료
